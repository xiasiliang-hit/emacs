...
;;cedet插件设置
;;==================================================
(add-to-list 'load-path "~/emacs.install/cedet-1.0/speedbar")
(add-to-list 'load-path "~/emacs.install/cedet-1.0/eieio")
(add-to-list 'load-path "~/emacs.install/cedet-1.0/semantic")
;; Load CEDET.,从cedet的INSTALL中复制过来的
;; See cedet/common/cedet.info for configuration details.
(load-file "~/emacs.install/cedet-1.0/common/cedet.el")
...
(yas/initialize)
(yas/load-directory "~/emacs.install/yasnippet-0.6.1c/snippets")
